...
const Beams = ({
  ...
  beamHeight = 12,
  beamNumber = 8,
  lightColor = "#DC2626", // Our red accent color
  speed = 1.5,
  noiseIntensity = 1.2,
  scale = 0.15,
  rotation = 0,
    ...
    <CanvasWrapper>
      <group rotation={[0, 0, degToRad(rotation)]}>
        <PlaneNoise
          ...
          height={beamHeight}
        />
        <DirLight color={lightColor} position={[0, 2, 8]} />
      </group>
...
const MergedPlanes = forwardRef(({ material, width, count, height }, ref) => {
  ...
  useFrame((_, delta) => {
    mesh.current.material.uniforms.time.value += 0.08 * delta;
  });
